"""Launch file for the discrete nstep DQN algorithm
...
parser.add_argument('-nsteps', type=int, help='nsteps', default=cfg['agent']['nsteps'])
...
def main(params):
    ...
    agent = NStepDQN(env, cfg['agent'], config['nsteps'])
    tag = 'NStepDQN'
